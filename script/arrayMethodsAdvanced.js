...
const findFruit = fruits.find(fruit => fruit.startsWith("🍌"))
...
const studentsNameMap = students.map(student => student.name)

console.log("Namn på studenter med map: ", studentsNameMap)

const studentsNameForEach = students.forEach(student => student.name)

console.log("Namn på studenter med forEach: ", studentsNameForEach)
...
console.log("Produnkter: ", electronics)

const findProduct = products.find((product) => product.id === 19)
